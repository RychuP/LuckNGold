namespace LuckNGold.Screens;

internal class RootScreen : ScreenObject
{
    readonly ScreenSurface _mainSurface;
    ...
    public RootScreen()
    {
        ...
        _mainSurface.Fill(new Rectangle(3, 3, 28, 3), Color.Violet, Color.LightBlue, 0, Mirror.None);

        // Print some text at (4, 4) using the foreground and background already there (violet and black)
        _mainSurface.Print(4, 4, "Luck N' Gold beginnings...");
