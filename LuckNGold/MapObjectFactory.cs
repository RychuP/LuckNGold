...
/// The integration library offers a robust component system that integrates both SadConsole's and 
/// GoRogue's components into one interface. You can either add more functions to create more objects, 
/// or remove this and implement the "factory" system in the GoRogue.Factories namespace, 
/// which provides a more robust interface for it.
///
