...
internal class MotionsSelectorScreen : MenuScreen
{
    public const string Name = "Motion Controls";
    public const string Description = "Select between Arrow, Numpad, " +
    ...
    public MotionsSelectorScreen()
    {
        ...
        AddButton("Back", Program.RootScreen.Show<SettingsScreen>);

        FocusFirstControl();
    }

    void CheckBox_OnIsSelectedChanged(object? o, EventArgs e)
    {
