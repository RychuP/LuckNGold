...
/// and moves enemies as appropriate when the player moves.
/// </summary>
/// 
/// <remarks>
/// CUSTOMIZATION: This component is meant to be attached directly to the player entity; 
/// if you want to attach it to a renderer, map, or other surface instead, 
/// you'll need to edit the MotionHandler to reference the player directly instead of using 
/// the Parent property. You may also want to change the parent class type parameter 
/// to specify a different type for the parent.
///
